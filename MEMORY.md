...
**Nome:** Tabuada Rush  
**Versão:** 6.0.29 (Reset completo + Poções de XP (Fase 4) + Loja rotativa (Fase 5) + Baús/recompensas (Fase 6) + Resumo pós-partida (Fase 7) + revisão visual bloco 1 (Fase 7.1, resto na Fase 7.1/7.2) · sessao-080; backlog grande em andamento, ver `PLANO_ACAO.md`)  
