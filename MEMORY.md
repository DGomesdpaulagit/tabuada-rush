...
**Nome:** Tabuada Rush  
**Versão:** 6.0.6 (Reset completo + débitos fechados + Ligas recalibradas + Ligas refeita da referência + header no canto · sessao-056; ver `sessions/planejamento-6.0.md`)  
