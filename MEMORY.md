...
**Nome:** Tabuada Rush  
**Versão:** 6.0.25 (Reset completo + Poções de XP (Fase 4) + Loja rotativa (Fase 5) + Baús/recompensas (Fase 6) + Resumo pós-partida (Fase 7) · sessao-076; backlog grande em andamento, ver `PLANO_ACAO.md`)  
